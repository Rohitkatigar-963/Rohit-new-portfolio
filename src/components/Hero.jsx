...
import pictureImg from '../assets/Portfolio/rohit.png';
...
const Hero = () => {
  ...
  const developerRoles = [
    'ORIGINAL SERIES // AI ENGINEER',
    'FEATURED // GENERATIVE AI & LLM SYSTEMS',
    'BLOCKBUSTER // AGENTIC AI & RAG',
    'ACCLAIMED // AI AUTOMATION & COMPUTER VISION'
  ];
    ...
    >
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none overflow-hidden opacity-10">
          <div className="flex whitespace-nowrap animate-marquee">
            {[...developerRoles, ...developerRoles].map((role, idx) => (
              <span key={idx} className="text-[14vw] font-black text-violet-500 mx-8 uppercase tracking-tighter">
                {role} &bull;
              </span>
            ))}
          </div>
      ...
      <div ref={contentRef} className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 h-full flex flex-col justify-between pt-24 pb-12">
        ...
        <div className="hero-anim-item flex items-center justify-between w-full">
          <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded bg-black/80 backdrop-blur-2xl border border-violet-500/40 text-xs font-mono uppercase tracking-widest text-white shadow-2xl">
            <span className="w-2 h-2 rounded-full bg-violet-500 animate-ping"></span>
            <span className="text-cyan-400 font-bold tracking-wider">AI ENGINEER SERIES</span>
          ...
          <div className="hidden md:flex items-center gap-2 text-xs font-mono text-white/50 tracking-wider">
            <span className="px-2 py-0.5 border border-white/20 rounded bg-black/40">GENAI 4K</span>
            <span className="px-2 py-0.5 border border-white/20 rounded bg-black/40">PRODUCTION AI</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-8 my-auto">
          ...
          <div className="lg:col-span-5 flex flex-col items-start space-y-5 text-left">
            ...
            <div className="hero-anim-item flex items-center gap-3">
              <span className="px-2.5 py-0.5 bg-violet-500 text-white font-black text-xs rounded tracking-widest shadow-[0_0_20px_rgba(139,92,246,0.8)] animate-pulse">AI ENGINEER</span>
              <span className="text-white/80 text-xs font-mono tracking-widest uppercase">Generative AI & Agentic AI Developer</span>
            </div>
            ...
            <h1 className="hero-anim-item text-5xl md:text-7xl font-black tracking-tighter text-white leading-[0.95] drop-shadow-[0_15px_30px_rgba(0,0,0,0.9)]">
              ROHIT <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-violet-600 to-violet-600 drop-shadow-[0_0_35px_rgba(139,92,246,0.5)]">
                KATIGAR.AI
              </span>
            </h1>

            <div className="hero-anim-item flex items-center gap-3 text-xs font-mono text-cyan-300 font-bold">
              <span className="px-2 py-0.5 bg-cyan-400/10 border border-cyan-400/30 rounded text-cyan-400">RAG • AGENTS</span>
              <span className="text-white/40">•</span>
              <span>Python • LangChain • FastAPI</span>
              <span className="text-white/40">•</span>
              <span className="text-white/70">n8n • Docker</span>
            </div>

            <p className="hero-anim-item text-sm md:text-base text-white/80 font-light leading-relaxed max-w-md drop-shadow">
              Building practical AI systems with RAG, agentic workflows, LLM applications, automation, and production-ready APIs.
            </p>
            ...
            <div className="hero-anim-item flex items-center gap-4 pt-2">
              <a
                href="#projects"
                className="px-8 py-3.5 bg-white text-black font-bold text-xs uppercase tracking-widest rounded hover:bg-violet-500 hover:text-white transition-all duration-300 shadow-[0_10px_35px_rgba(255,255,255,0.3)] flex items-center gap-2 hover:scale-105 active:scale-95"
              >
          ...
          <div className="lg:col-span-4 flex justify-center perspective-[1200px]">
            ...
            >
              ...
              <div className="absolute -inset-3 bg-gradient-to-r from-violet-500/70 via-violet-600/40 to-purple-600/20 rounded-3xl blur-3xl opacity-90 group-hover:opacity-100 animate-pulse duration-1000"></div>
              
              {/* Poster Card with Glossy Sheen */}
              <div className="relative w-[280px] md:w-[320px] p-3.5 bg-[#141414]/90 backdrop-blur-2xl rounded-2xl border border-violet-500/40 shadow-[0_40px_80px_rgba(0,0,0,0.95)] overflow-hidden">
                ...
                {/* Netflix Series Tag */}
                <div className="absolute top-6 left-6 z-30 px-3 py-1 bg-violet-500 text-white font-mono text-[10px] font-bold tracking-widest rounded shadow-xl">
                  AI ENGINEER
                </div>
          ...
          <div className="hero-anim-item lg:col-span-3 flex flex-col items-start lg:items-end space-y-4 text-left lg:text-right">
            <div className="p-5 bg-black/80 backdrop-blur-2xl border border-white/15 rounded-xl shadow-2xl max-w-xs">
              <h3 className="text-xs font-mono uppercase tracking-widest text-cyan-400 font-bold mb-2">Core Stack & Awards</h3>
              <p className="text-xs text-white/80 leading-relaxed font-light">
                Generative AI, Agentic AI, LLM applications, RAG, AI automation, Python, FastAPI, LangChain, PyTorch.
              </p>
            </div>
          </div>
      ...
      <div
        ref={cursorDotRef}
        className="absolute top-0 left-0 z-50 pointer-events-none w-3 h-3 bg-violet-500 rounded-full shadow-[0_0_15px_#8B5CF6]"
      ></div>

      <div
        ref={cursorRingRef}
        className="absolute top-0 left-0 z-50 pointer-events-none w-12 h-12 border border-violet-500/60 rounded-full flex items-center justify-center backdrop-blur-[1px]"
      ></div>
      ...
      <header className="absolute top-0 left-0 z-50 w-full max-w-7xl mx-auto px-6 md:px-12 py-6 flex items-center justify-between pointer-events-auto">
        <div className="text-2xl font-black text-violet-500 tracking-tighter flex items-center gap-2 drop-shadow-[0_2px_15px_rgba(229,9,20,0.9)]">
          ROHIT<span className="w-1.5 h-1.5 rounded-full bg-white inline-block"></span>
        </div>
        ...
        <a
          href="https://drive.google.com/file/d/1xOyFExzxf8Ov4UZ8yktpolvNek9_PQAW/view?usp=drive_link" target="_blank" rel="noopener noreferrer"
          className="px-5 py-2 rounded bg-violet-500 hover:bg-violet-600 text-white font-bold text-xs uppercase tracking-widest transition-all duration-300 shadow-[0_0_20px_rgba(139,92,246,0.6)] hover:scale-105 active:scale-95"
        >
          Hire Me
        </a>
      </header>
