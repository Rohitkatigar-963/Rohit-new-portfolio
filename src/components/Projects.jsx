...
const projectsData = [
  {
    ...
    description: "Built an Agentic RAG support agent for multi-step customer query resolution, with tool calling, conversation memory, human escalation, and authoritative policy grounding.",
    tags: ["Python", "Google Gemini", "FastAPI", "FAISS", "RAG"],
    match: "98%",
    episode: "PROJECT 01"
  },
  {
    title: "AskEdge",
    category: "Multi-Department AI Learning Assistant",
    description: "Built an AI learning assistant with department-aware agent routing for CSE, ECE, ME, and CE, plus web search and structured EDGE-based responses.",
    tags: ["n8n", "Google Gemini", "AI Agents", "Web Search"],
    match: "97%",
    episode: "PROJECT 02"
  },
  {
    title: "XrayAI",
    category: "Computer Vision & AI Assistant",
    description: "Built a chest X-ray classification system using PyTorch and DenseNet121 for COVID-19, Normal, and Pneumonia classes, with an n8n Gemini chatbot and search/calculator tools.",
    tags: ["PyTorch", "DenseNet121", "Computer Vision", "n8n", "Gemini"],
    match: "96%",
    episode: "PROJECT 03"
  }
];
...
const Projects = () => {
  ...
  return (
    <section id="projects" ref={containerRef} className="bg-[#0b0b0b] min-h-[100svh] md:min-h-[145vh] relative font-sans overflow-x-clip text-white w-full flex items-center justify-center py-24 md:py-40 select-none">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[55vw] h-[55vw] bg-violet-500/15 rounded-full blur-[160px] pointer-events-none z-0" />

      {/* Main Perspective Container */}
      <div className="mt-12 relative w-full max-w-6xl h-full flex items-center justify-center perspective-[2000px] z-10">
        ...
        <div className="relative w-0 h-0 transform-style-3d">
          ...
          <div 
            ref={folderBackRef}
            className="absolute w-[85vw] md:w-[32vw] max-w-[380px] aspect-video bg-[#141414] rounded-[24px] border border-violet-500/40 shadow-[0_20px_50px_rgba(139,92,246,0.25)] flex items-center justify-center"
            style={{ zIndex: 5 }}
          >
            <div className="absolute -top-6 left-6 w-32 h-8 bg-[#1f1f1f] rounded-t-xl border-t border-violet-500/30" />
            <div className="relative z-10 text-violet-500 font-mono font-black text-2xl tracking-widest uppercase opacity-60">
              3 FEATURED PROJECTS
            </div>
          </div>
              ...
              <div className="w-full h-full rounded-[24px] overflow-hidden border border-white/15 bg-[#141414]/95 backdrop-blur-2xl shadow-[0_25px_50px_rgba(0,0,0,0.9)] transition-all duration-500 group hover:scale-[1.04] hover:border-violet-500 hover:shadow-[0_35px_80px_rgba(139,92,246,0.35)] hover:-translate-y-2 cursor-pointer relative z-10 p-7 flex flex-col justify-between">
                ...
                <div className="flex flex-wrap gap-1.5 pt-3 border-t border-white/10">
                  {project.tags.map((tag, tIdx) => (
                    <span key={tIdx} className="text-[10px] font-mono text-white/70 bg-white/5 px-2 py-0.5 rounded group-hover:border-violet-500/30 transition-colors">
                      {tag}
                    </span>
                  ))}
                </div>
          ...
          <div 
            ...
            style={{ zIndex: 60 }}
          >
            <div className="absolute bottom-0 w-full h-[85%] bg-[#1c1c1c] rounded-b-[24px] rounded-t-md shadow-[0_-5px_20px_rgba(0,0,0,0.8)] flex flex-col justify-end p-6 border-t border-violet-500/40">
        ...
        {projectsData.map((project, i) => (
          ...
          >
            <div className="w-full h-full rounded-[24px] overflow-hidden border border-white/15 bg-[#141414] p-6 flex flex-col justify-between shadow-[0_20px_40px_rgba(0,0,0,0.9)]">
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-mono font-bold tracking-widest text-cyan-400 bg-violet-500/10 px-2 py-0.5 rounded">
                  {project.episode}
                </span>
                <span className="text-xs font-mono text-cyan-300 font-bold">{project.match} Match</span>
              </div>
