      ...
      <div className="max-w-7xl mx-auto flex flex-col space-y-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 pb-12 border-b border-white/10">
          <div className="space-y-2">
            <div className="text-2xl font-black text-violet-500 tracking-tighter flex items-center gap-2 drop-shadow-[0_2px_15px_rgba(139,92,246,0.9)]">
            ...
            <p className="text-xs font-mono text-white/50 tracking-widest uppercase">
              // AI ENGINEER SERIES &bull; SEASON 2026
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 text-xs font-mono text-white/60">
          <div className="flex items-center gap-6">
            <a 
              href="<a 
              href="https://github.com/Rohitkatigar-963"
              target="_blank" 
            ...
            <a 
              href="https://www.linkedin.com/in/rohit-katigar-a086b62b2"
              target="_blank" 
              rel="noopener noreferrer"
              className="hover:text-cyan-400 transition-colors uppercase tracking-wider"
            >
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 pt-6 border-t border-white/5 text-[11px] font-mono text-white/40 uppercase tracking-widest">
          <p>&copy; {new Date().getFullYear()} Rohit Katigar. All Rights Reserved.</p>
          <p className="text-cyan-400/80">STREAMING WORLDWIDE &bull; BUILT WITH REACT & GSAP</p>
        </div>
